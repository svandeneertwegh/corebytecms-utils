    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('function', models.CharField(max_length=255, verbose_name='Functie')),
                ...
                ('linkedin', models.URLField(blank=True, verbose_name='LinkedIn pagina')),
                ('twitter', models.URLField(blank=True, verbose_name='Twitter pagina')),
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='Email adres')),
            ],
            options={
